...
func (x *DealerDto) GetStateName() string {
	if x != nil {
		return x.StateName
	}
	return ""
...
func (x *DealerDto) GetAreaName() string {
	if x != nil {
		return x.AreaName
	}
	return ""
...
func (x *DealerDto) GetStatusDescription() string {
	if x != nil {
...
var file_dealer_dealer_proto_rawDesc = []byte{
	...
	0x6f, 0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x91, 0x04, 0x0a, 0x09, 0x44, 0x65, 0x61,
...
var file_dealer_dealer_proto_depIdxs = []int32{
	...
	2, // 3: dealer.Dealer.List:input_type -> common.Page
	2, // 4: dealer.Dealer.SyncDealer:input_type -> common.Page
	3, // 5: dealer.Dealer.Get:input_type -> common.IdLocalDTO
	4, // 6: dealer.Dealer.Add:output_type -> common.Response
	4, // 7: dealer.Dealer.Delete:output_type -> common.Response
	4, // 8: dealer.Dealer.Update:output_type -> common.Response
	4, // 9: dealer.Dealer.List:output_type -> common.Response
	4, // 10: dealer.Dealer.SyncDealer:output_type -> common.Response
	4, // 11: dealer.Dealer.Get:output_type -> common.Response
