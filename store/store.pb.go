...
type StoreDTO struct {
	...
	MapUrl                 string `protobuf:"bytes,18,opt,name=mapUrl,proto3" json:"mapUrl,omitempty"`
...
func (x *StoreDTO) GetMapUrl() string {
	if x != nil {
		return x.MapUrl
	}
	return ""
...
var file_store_store_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x03, 0x28, 0x04, 0x52, 0x03, 0x69, 0x64, 0x73, 0x22, 0xb5, 0x04, 0x0a, 0x08, 0x53,
	...
	0x09, 0x52, 0x05, 0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x6d, 0x61, 0x70, 0x55,
	0x72, 0x6c, 0x18, 0x12, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x6d, 0x61, 0x70, 0x55, 0x72, 0x6c,
	...
	0x72, 0x6c, 0x22, 0xb1, 0x05, 0x0a, 0x0c, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x4c, 0x69, 0x73, 0x74,
	...
	0x65, 0x73, 0x73, 0x55, 0x72, 0x6c, 0x22, 0x34, 0x0a, 0x0e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x53,
	...
	0x65, 0x32, 0xd9, 0x02, 0x0a, 0x05, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x2a, 0x0a, 0x03, 0x41,
	0x64, 0x64, 0x12, 0x0f, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65,
	...
	0x15, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x43, 0x6f, 0x6e,
	...
	0x64, 0x61, 0x74, 0x65, 0x12, 0x0f, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x53, 0x74, 0x6f,
	...
	0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x28, 0x0a, 0x03, 0x47, 0x65, 0x74, 0x12, 0x0d, 0x2e,
	...
	0x12, 0x38, 0x0a, 0x13, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x69, 0x6d, 0x70, 0x6c, 0x65, 0x49, 0x6e,
	0x66, 0x6f, 0x42, 0x79, 0x49, 0x64, 0x73, 0x12, 0x0d, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e,
	0x49, 0x64, 0x73, 0x44, 0x74, 0x6f, 0x1a, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x31, 0x0a, 0x0c, 0x4c, 0x69,
	0x73, 0x74, 0x4c, 0x6f, 0x63, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x12, 0x0d, 0x2e, 0x73, 0x74, 0x6f,
...
var file_store_store_proto_goTypes = []interface{}{
	...
	(*StoreListDTO)(nil),    // 3: store.StoreListDTO
	(*StoreSimpleDto)(nil),  // 4: store.StoreSimpleDto
	(*StoreCondition)(nil),  // 5: store.StoreCondition
...
var file_store_store_proto_depIdxs = []int32{
	6, // 0: store.StoreCondition.page:type_name -> common.Page
	2, // 1: store.Store.Add:input_type -> store.StoreDTO
	5, // 2: store.Store.List:input_type -> store.StoreCondition
	2, // 3: store.Store.Update:input_type -> store.StoreDTO
	7, // 4: store.Store.Delete:input_type -> common.IdDto
	7, // 5: store.Store.Get:input_type -> common.IdDto
	1, // 6: store.Store.ListSimpleInfoByIds:input_type -> store.IdsDto
	1, // 7: store.Store.ListLocation:input_type -> store.IdsDto
	8, // 8: store.Store.Add:output_type -> common.Response
	8, // 9: store.Store.List:output_type -> common.Response
	8, // 10: store.Store.Update:output_type -> common.Response
	8, // 11: store.Store.Delete:output_type -> common.Response
	8, // 12: store.Store.Get:output_type -> common.Response
	8, // 13: store.Store.ListSimpleInfoByIds:output_type -> common.Response
	8, // 14: store.Store.ListLocation:output_type -> common.Response
