...
var file_store_proto_rawDesc = []byte{
	...
	0x69, 0x64, 0x32, 0xa4, 0x06, 0x0a, 0x05, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x2a, 0x0a, 0x03,
...
var file_store_proto_goTypes = []interface{}{
	...
	(*common.IdDto)(nil),            // 15: common.IdDto
...
var file_store_proto_depIdxs = []int32{
	...
	14, // 1: store.StoreCondition.page:type_name -> common.Page
	11, // 2: store.TimeSlotList.list:type_name -> store.TimeSlotEle
	14, // 3: store.StoreInvalidTime.page:type_name -> common.Page
	...
	15, // 7: store.Store.Delete:input_type -> common.IdDto
	15, // 8: store.Store.Get:input_type -> common.IdDto
	...
	16, // 18: store.Store.Add:output_type -> common.Response
	16, // 19: store.Store.List:output_type -> common.Response
	16, // 20: store.Store.Update:output_type -> common.Response
	16, // 21: store.Store.Delete:output_type -> common.Response
	16, // 22: store.Store.Get:output_type -> common.Response
	16, // 23: store.Store.ListSimpleInfoByIds:output_type -> common.Response
	16, // 24: store.Store.ListLocation:output_type -> common.Response
	16, // 25: store.Store.ListStoreInvalidTimeDTO:output_type -> common.Response
	16, // 26: store.Store.AddOrUpdate:output_type -> common.Response
	16, // 27: store.Store.AddOrUpdateList:output_type -> common.Response
	16, // 28: store.Store.GenTimeSlotCache:output_type -> common.Response
	16, // 29: store.Store.GetTimeSlotCache:output_type -> common.Response
	16, // 30: store.Store.GetTimeSlotCacheAll:output_type -> common.Response
	16, // 31: store.Store.AddAppointmentNum:output_type -> common.Response
