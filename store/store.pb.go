...
type TimeSlotStatus struct {
	...
	Id            uint64  `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty"`
	BeginTimeList []int64 `protobuf:"varint,2,rep,packed,name=beginTimeList,proto3" json:"beginTimeList,omitempty"`
	EndTimeList   []int64 `protobuf:"varint,3,rep,packed,name=endTimeList,proto3" json:"endTimeList,omitempty"`
	Type          uint32  `protobuf:"varint,4,opt,name=type,proto3" json:"type,omitempty"`
}

func (x *TimeSlotStatus) Reset() {
	*x = TimeSlotStatus{}
	if protoimpl.UnsafeEnabled {
...
func (*TimeSlotStatus) ProtoMessage() {}

func (x *TimeSlotStatus) ProtoReflect() protoreflect.Message {
	mi := &file_store_proto_msgTypes[14]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use TimeSlotStatus.ProtoReflect.Descriptor instead.
func (*TimeSlotStatus) Descriptor() ([]byte, []int) {
	return file_store_proto_rawDescGZIP(), []int{14}
}

func (x *TimeSlotStatus) GetId() uint64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *TimeSlotStatus) GetBeginTimeList() []int64 {
	if x != nil {
		return x.BeginTimeList
	}
	return nil
}

func (x *TimeSlotStatus) GetEndTimeList() []int64 {
	if x != nil {
		return x.EndTimeList
	}
	return nil
}

func (x *TimeSlotStatus) GetType() uint32 {
	if x != nil {
		return x.Type
	}
	return 0
...
var file_store_proto_rawDesc = []byte{
	...
	,
	...
	0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x42, 0x0a, 0x15, 0x47, 0x65, 0x74, 0x54, 0x69,
	0x6d, 0x65, 0x53, 0x6c, 0x6f, 0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4c, 0x69, 0x73, 0x74,
	0x12, 0x15, 0x2e, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2e, 0x54, 0x69, 0x6d, 0x65, 0x53, 0x6c, 0x6f,
	0x74, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x1a, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
...
var file_store_proto_goTypes = []interface{}{
	...
	(*TimeSlotStatus)(nil),          // 14: store.TimeSlotStatus
...
var file_store_proto_depIdxs = []int32{
	...
	15, // 1: store.StoreCondition.page:type_name -> common.Page
	11, // 2: store.TimeSlotList.list:type_name -> store.TimeSlotEle
	15, // 3: store.StoreInvalidTime.page:type_name -> common.Page
	...
	16, // 7: store.Store.Delete:input_type -> common.IdDto
	16, // 8: store.Store.Get:input_type -> common.IdDto
	...
	14, // 18: store.Store.GetTimeSlotStatusList:input_type -> store.TimeSlotStatus
	17, // 19: store.Store.Add:output_type -> common.Response
	17, // 20: store.Store.List:output_type -> common.Response
	17, // 21: store.Store.Update:output_type -> common.Response
	17, // 22: store.Store.Delete:output_type -> common.Response
	17, // 23: store.Store.Get:output_type -> common.Response
	17, // 24: store.Store.ListSimpleInfoByIds:output_type -> common.Response
	17, // 25: store.Store.ListLocation:output_type -> common.Response
	17, // 26: store.Store.ListStoreInvalidTimeDTO:output_type -> common.Response
	17, // 27: store.Store.AddOrUpdate:output_type -> common.Response
	17, // 28: store.Store.AddOrUpdateList:output_type -> common.Response
	17, // 29: store.Store.GenTimeSlotCache:output_type -> common.Response
	17, // 30: store.Store.GetTimeSlotCache:output_type -> common.Response
	17, // 31: store.Store.GetTimeSlotCacheAll:output_type -> common.Response
	17, // 32: store.Store.AddAppointmentNum:output_type -> common.Response
	17, // 33: store.Store.GetTimeSlotStatusList:output_type -> common.Response
