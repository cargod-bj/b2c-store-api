...
var file_store_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x04, 0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x32, 0x9a, 0x06, 0x0a,
...
var file_store_proto_depIdxs = []int32{
	...
	9,  // 15: store.Store.GetTimeSlotCacheAll:input_type -> store.GetTimeSlotCon
	12, // 16: store.Store.AddAppointmentNum:input_type -> store.AddAppointmentCon
	15, // 17: store.Store.Add:output_type -> common.Response
	15, // 18: store.Store.List:output_type -> common.Response
	15, // 19: store.Store.Update:output_type -> common.Response
	15, // 20: store.Store.Delete:output_type -> common.Response
	15, // 21: store.Store.Get:output_type -> common.Response
	15, // 22: store.Store.ListSimpleInfoByIds:output_type -> common.Response
	15, // 23: store.Store.ListLocation:output_type -> common.Response
	15, // 24: store.Store.ListStoreInvalidTimeDTO:output_type -> common.Response
	15, // 25: store.Store.AddOrUpdate:output_type -> common.Response
	15, // 26: store.Store.AddOrUpdateList:output_type -> common.Response
	15, // 27: store.Store.GenTimeSlotCache:output_type -> common.Response
	15, // 28: store.Store.GetTimeSlotCache:output_type -> common.Response
	15, // 29: store.Store.GetTimeSlotCacheAll:output_type -> common.Response
	15, // 30: store.Store.AddAppointmentNum:output_type -> common.Response
