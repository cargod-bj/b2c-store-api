...
var file_store_proto_rawDesc = []byte{
	...
	0x32, 0xb1, 0x07, 0x0a, 0x05, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x2a, 0x0a, 0x03, 0x41, 0x64,
	...
	0x6d, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x44,
	0x0a, 0x1f, 0x44, 0x65, 0x6c, 0x65, 0x74, 0x65, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x6e, 0x76,
	0x61, 0x6c, 0x69, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x42, 0x79, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x49,
	0x64, 0x12, 0x0d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x49, 0x64, 0x44, 0x74, 0x6f,
	0x1a, 0x10, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e,
...
var file_store_proto_depIdxs = []int32{
	...
	17, // 20: store.Store.DeleteStoreInvalidTimeByStoreId:input_type -> common.IdDto
	18, // 21: store.Store.Add:output_type -> common.Response
	18, // 22: store.Store.List:output_type -> common.Response
	18, // 23: store.Store.Update:output_type -> common.Response
	18, // 24: store.Store.Delete:output_type -> common.Response
	18, // 25: store.Store.Get:output_type -> common.Response
	18, // 26: store.Store.ListSimpleInfoByIds:output_type -> common.Response
	18, // 27: store.Store.ListLocation:output_type -> common.Response
	18, // 28: store.Store.ListStoreInvalidTimeDTO:output_type -> common.Response
	18, // 29: store.Store.AddOrUpdate:output_type -> common.Response
	18, // 30: store.Store.AddOrUpdateList:output_type -> common.Response
	18, // 31: store.Store.GenTimeSlotCache:output_type -> common.Response
	18, // 32: store.Store.GetTimeSlotCache:output_type -> common.Response
	18, // 33: store.Store.GetTimeSlotCacheAll:output_type -> common.Response
	18, // 34: store.Store.AddAppointmentNum:output_type -> common.Response
	18, // 35: store.Store.GetTimeSlotStatusList:output_type -> common.Response
	18, // 36: store.Store.DeleteStoreInvalidTimeByStoreId:output_type -> common.Response
