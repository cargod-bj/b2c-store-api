...
var file_store_proto_rawDesc = []byte{
	...
	0x32, 0x8f, 0x04, 0x0a, 0x05, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x2a, 0x0a, 0x03, 0x41, 0x64,
	...
	0x6e, 0x2e, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x3c, 0x0a, 0x17,
	0x4c, 0x69, 0x73, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x6e, 0x76, 0x61, 0x6c, 0x69, 0x64,
	0x54, 0x69, 0x6d, 0x65, 0x44, 0x54, 0x4f, 0x12, 0x0d, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e,
	...
	0x64, 0x4f, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x1a, 0x2e, 0x73, 0x74, 0x6f, 0x72,
...
var file_store_proto_goTypes = []interface{}{
	...
	(*common.IdDto)(nil),            // 10: common.IdDto
...
var file_store_proto_depIdxs = []int32{
	...
	9,  // 1: store.StoreCondition.page:type_name -> common.Page
	5,  // 2: store.Store.Add:input_type -> store.StoreDTO
	8,  // 3: store.Store.List:input_type -> store.StoreCondition
	5,  // 4: store.Store.Update:input_type -> store.StoreDTO
	10, // 5: store.Store.Delete:input_type -> common.IdDto
	10, // 6: store.Store.Get:input_type -> common.IdDto
	3,  // 7: store.Store.ListSimpleInfoByIds:input_type -> store.IdsDto
	3,  // 8: store.Store.ListLocation:input_type -> store.IdsDto
	10, // 9: store.Store.ListStoreInvalidTimeDTO:input_type -> common.IdDto
	1,  // 10: store.Store.AddOrUpdate:input_type -> store.StoreInvalidTimeDTO
	4,  // 11: store.Store.GenTimeSlotCache:input_type -> store.DateList
	11, // 12: store.Store.Add:output_type -> common.Response
	11, // 13: store.Store.List:output_type -> common.Response
	11, // 14: store.Store.Update:output_type -> common.Response
	11, // 15: store.Store.Delete:output_type -> common.Response
	11, // 16: store.Store.Get:output_type -> common.Response
	11, // 17: store.Store.ListSimpleInfoByIds:output_type -> common.Response
	11, // 18: store.Store.ListLocation:output_type -> common.Response
	11, // 19: store.Store.ListStoreInvalidTimeDTO:output_type -> common.Response
	11, // 20: store.Store.AddOrUpdate:output_type -> common.Response
	11, // 21: store.Store.GenTimeSlotCache:output_type -> common.Response
