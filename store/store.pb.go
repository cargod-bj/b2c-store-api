...
var file_store_store_proto_rawDesc = []byte{
	...
	0x75, 0x6e, 0x74, 0x32, 0xce, 0x04, 0x0a, 0x05, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x12, 0x2a, 0x0a,
	...
	0x3c, 0x0a, 0x17, 0x4c, 0x69, 0x73, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x49, 0x6e, 0x76, 0x61,
	0x6c, 0x69, 0x64, 0x54, 0x69, 0x6d, 0x65, 0x44, 0x54, 0x4f, 0x12, 0x0d, 0x2e, 0x63, 0x6f, 0x6d,
	...
	0x0b, 0x41, 0x64, 0x64, 0x4f, 0x72, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65, 0x12, 0x1a, 0x2e, 0x73,
...
var file_store_store_proto_msgTypes = make([]protoimpl.MessageInfo, 12)
...
var file_store_store_proto_depIdxs = []int32{
	...
	12, // 1: store.StoreCondition.page:type_name -> common.Page
	...
	13, // 6: store.Store.Delete:input_type -> common.IdDto
	13, // 7: store.Store.Get:input_type -> common.IdDto
	3,  // 8: store.Store.ListSimpleInfoByIds:input_type -> store.IdsDto
	3,  // 9: store.Store.ListLocation:input_type -> store.IdsDto
	13, // 10: store.Store.ListStoreInvalidTimeDTO:input_type -> common.IdDto
	...
	14, // 14: store.Store.Add:output_type -> common.Response
	14, // 15: store.Store.List:output_type -> common.Response
	14, // 16: store.Store.Update:output_type -> common.Response
	14, // 17: store.Store.Delete:output_type -> common.Response
	14, // 18: store.Store.Get:output_type -> common.Response
	14, // 19: store.Store.ListSimpleInfoByIds:output_type -> common.Response
	14, // 20: store.Store.ListLocation:output_type -> common.Response
	14, // 21: store.Store.ListStoreInvalidTimeDTO:output_type -> common.Response
	14, // 22: store.Store.AddOrUpdate:output_type -> common.Response
	14, // 23: store.Store.GenTimeSlotCache:output_type -> common.Response
	14, // 24: store.Store.GetTimeSlotCache:output_type -> common.Response
